...
namespace Evergine.Bindings.CesiumNative
{
	...
	{
		/// <summary>
		/// Byte index where this mip begins.
		/// </summary>
		public nuint ByteOffset;
		/// <summary>
		/// Size in bytes of this mip.
		/// </summary>
	...
	/// </summary>
	[StructLayout(LayoutKind.Sequential)]
	public unsafe partial struct Ktx2TranscodeTargets
	{
		public GpuCompressedPixelFormat ETC1SR;
		public GpuCompressedPixelFormat ETC1SRG;
		public GpuCompressedPixelFormat ETC1SRGB;
		public GpuCompressedPixelFormat ETC1SRGBA;
		public GpuCompressedPixelFormat UASTCR;
		public GpuCompressedPixelFormat UASTCRG;
		public GpuCompressedPixelFormat UASTCRGB;
		public GpuCompressedPixelFormat UASTCRGBA;
	}
	...
	public unsafe partial struct RasterOverlayOptions
	{
		...
		/// </summary>
		public int ShowCreditsOnScreen;
		/// <summary>
		...
		/// </summary>
		public Ktx2TranscodeTargets Ktx2TranscodeTargets;
	}
}
